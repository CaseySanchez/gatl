...
namespace ga {
    ...
    GA_HOST_DEVICE constexpr decltype(auto) conjugate(clifford_expression<CoefficientType, Expression> const &arg) GA_NOEXCEPT {
    ...
    GA_HOST_DEVICE constexpr decltype(auto) conjugate(Type const &arg) GA_NOEXCEPT {

...
namespace ga {
    ...
    template<typename BaseCoefficientType, typename BaseCoefficient, typename ExponentType> requires (!is_clifford_expression_v<ExponentType>)
    ...
    template<typename BaseType, typename ExponentCoefficientType, typename ExponentCoefficient> requires (!is_clifford_expression_v<BaseType>)

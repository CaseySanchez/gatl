...
namespace ga {
    ...
    GA_HOST_DEVICE constexpr decltype(auto) pow(scalar_clifford_expression<BaseCoefficientType, BaseCoefficient> const &base, scalar_clifford_expression<ExponentCoefficientType, ExponentCoefficient> const &exponent) {
    ...
    GA_HOST_DEVICE constexpr decltype(auto) pow(scalar_clifford_expression<BaseCoefficientType, BaseCoefficient> const &base, ExponentType const &exponent) {
    ...
    GA_HOST_DEVICE constexpr decltype(auto) pow(BaseType const &base, scalar_clifford_expression<ExponentCoefficientType, ExponentCoefficient> const &exponent) {
    ...
    GA_HOST_DEVICE constexpr decltype(auto) sqrt(scalar_clifford_expression<CoefficientType, Coefficient> const &arg) {
    ...
    template<typename CoefficientType, typename Coefficient>
    GA_HOST_DEVICE constexpr decltype(auto) cbrt(scalar_clifford_expression<CoefficientType, Coefficient> const &arg) {
    ...
    template<typename CoefficientType, typename Coefficient>
    GA_HOST_DEVICE constexpr decltype(auto) abs(scalar_clifford_expression<CoefficientType, Coefficient> const &arg) GA_NOEXCEPT {
    ...
    template<typename CoefficientType, typename Coefficient>
    GA_HOST_DEVICE constexpr decltype(auto) exp(scalar_clifford_expression<CoefficientType, Coefficient> const &arg) GA_NOEXCEPT {
        auto lazy = make_lazy_context(arg);
    ...
    template<typename CoefficientType, typename Coefficient>
    GA_HOST_DEVICE constexpr decltype(auto) log(scalar_clifford_expression<CoefficientType, Coefficient> const &arg) {
        auto lazy = make_lazy_context(arg);
    ...
    template<typename CoefficientType, typename Coefficient>
    GA_HOST_DEVICE constexpr decltype(auto) cos(scalar_clifford_expression<CoefficientType, Coefficient> const &arg) GA_NOEXCEPT {
        auto lazy = make_lazy_context(arg);
    ...
    template<typename CoefficientType, typename Coefficient>
    GA_HOST_DEVICE constexpr decltype(auto) sin(scalar_clifford_expression<CoefficientType, Coefficient> const &arg) GA_NOEXCEPT {
        auto lazy = make_lazy_context(arg);
    ...
    template<typename CoefficientType, typename Coefficient>
    GA_HOST_DEVICE constexpr decltype(auto) tan(scalar_clifford_expression<CoefficientType, Coefficient> const &arg) GA_NOEXCEPT {
        auto lazy = make_lazy_context(arg);
    ...
    template<typename CoefficientType, typename Coefficient>
    GA_HOST_DEVICE constexpr decltype(auto) cosh(scalar_clifford_expression<CoefficientType, Coefficient> const &arg) GA_NOEXCEPT {
        auto lazy = make_lazy_context(arg);
    ...
    template<typename CoefficientType, typename Coefficient>
    GA_HOST_DEVICE constexpr decltype(auto) sinh(scalar_clifford_expression<CoefficientType, Coefficient> const &arg) GA_NOEXCEPT {
        auto lazy = make_lazy_context(arg);
    ...
    template<typename CoefficientType, typename Coefficient>
    GA_HOST_DEVICE constexpr decltype(auto) tanh(scalar_clifford_expression<CoefficientType, Coefficient> const &arg) GA_NOEXCEPT {
        auto lazy = make_lazy_context(arg);

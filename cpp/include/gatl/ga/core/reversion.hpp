...
namespace ga {
    ...
    GA_HOST_DEVICE constexpr decltype(auto) reverse(clifford_expression<CoefficientType, Expression> const &arg) GA_NOEXCEPT {
    ...
    GA_HOST_DEVICE constexpr decltype(auto) reverse(Type const &arg) GA_NOEXCEPT {

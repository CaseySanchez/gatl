...
namespace ga {
    ...
    GA_HOST_DEVICE constexpr decltype(auto) involute(clifford_expression<CoefficientType, Expression> const &arg) GA_NOEXCEPT {
    ...
    GA_HOST_DEVICE constexpr decltype(auto) involute(Type const &arg) GA_NOEXCEPT {

...
namespace ga {
    ...
    template<typename Type, typename PseudoscalarCoefficientType, typename PseudoscalarExpression, typename MetricSpaceType> requires(!is_clifford_expression_v<Type>)

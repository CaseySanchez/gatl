...
namespace ga {
    ...
    // Returns the k-grade part of the given Clifford expression.
    template<typename CoefficientType, typename Expression, typename GradeCoefficientType, typename GradeCoefficient> requires (std::is_constructible_v<grade_t, GradeCoefficientType>)
    ...
    template<typename Type, typename GradeCoefficientType, typename GradeCoefficient> requires (std::is_constructible_v<grade_t, GradeCoefficientType>)

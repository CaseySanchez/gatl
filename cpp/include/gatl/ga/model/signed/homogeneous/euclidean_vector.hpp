...
namespace ga {
    ...
    GA_HOST_DEVICE constexpr decltype(auto) euclidean_vector(homogeneous_metric_space<D> const &mtr, Types &&... coords) GA_NOEXCEPT {
    ...
    GA_HOST_DEVICE constexpr decltype(auto) euclidean_vector(homogeneous_metric_space<D> const &mtr, IteratorType begin, IteratorType end) GA_NOEXCEPT {

...
namespace ga {
    ...
    GA_HOST_DEVICE constexpr decltype(auto) dual_flat_location(clifford_expression<CoefficientType, Expression> const &dual_flat, minkowski_metric_space<D> const &mtr) {
    ...
    template<typename CoefficientType, typename Expression, ndims_t D>
    GA_HOST_DEVICE constexpr decltype(auto) primal_flat_location(clifford_expression<CoefficientType, Expression> const &primal_flat, minkowski_metric_space<D> const &mtr) {

...
namespace ga {
    ...
    GA_HOST_DEVICE constexpr decltype(auto) dual_round_location(clifford_expression<CoefficientType, Expression> const &dual_round, minkowski_metric_space<D> const &mtr) {
    ...
    template<typename CoefficientType, typename Expression, ndims_t D>
    GA_HOST_DEVICE constexpr decltype(auto) primal_round_location(clifford_expression<CoefficientType, Expression> const &primal_round, minkowski_metric_space<D> const &mtr) {

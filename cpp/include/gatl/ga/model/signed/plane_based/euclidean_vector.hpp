...
namespace ga {
    ...
    GA_HOST_DEVICE constexpr decltype(auto) euclidean_vector(plane_based_metric_space<D> const &mtr, Types &&... coords) GA_NOEXCEPT {
    ...
    GA_HOST_DEVICE constexpr decltype(auto) euclidean_vector(plane_based_metric_space<D> const &mtr, IteratorType begin, IteratorType end) GA_NOEXCEPT {

...
namespace ga {
    ...
    namespace detail {
        ...
        struct make_vector_sequential_storage_simple {
            ...
            GA_ALWAYS_INLINE GA_HOST_DEVICE constexpr static decltype(auto) run(Types &&... coords) GA_NOEXCEPT {
        ...
        private:
            ...
            GA_ALWAYS_INLINE GA_HOST_DEVICE constexpr static decltype(auto) to_values_tuple(sequential_storage<ValueType, Size> &&values, std::index_sequence<Indices...> const) GA_NOEXCEPT {
                return std::tie(std::get<Indices>(std::move(values))...);
            }

            template<typename ValueType, std::size_t Size>
            GA_ALWAYS_INLINE GA_HOST_DEVICE constexpr static decltype(auto) to_values_tuple(sequential_storage<ValueType, Size> &&values) GA_NOEXCEPT {
                return to_values_tuple(std::move(values), std::make_index_sequence<Size>{});
            }

            template<typename ValueType>
            GA_ALWAYS_INLINE GA_HOST_DEVICE constexpr static decltype(auto) to_values_tuple(sequential_storage<ValueType, 0> &&) GA_NOEXCEPT {
                return std::make_tuple();
            }

            GA_ALWAYS_INLINE GA_HOST_DEVICE constexpr static decltype(auto) make_values_tuple() GA_NOEXCEPT {
                return std::make_tuple();
            }

            template<typename CoordinateType, typename... NextTypes>
            GA_ALWAYS_INLINE GA_HOST_DEVICE constexpr static decltype(auto) make_values_tuple(CoordinateType &&coord, NextTypes &&... next_coords) GA_NOEXCEPT {
            ...
            GA_ALWAYS_INLINE GA_HOST_DEVICE constexpr static decltype(auto) make_values_tuple(scalar_clifford_expression<CoefficientType, Coefficient> const &&coord, NextTypes &&... next_coords) GA_NOEXCEPT {
            ...
            GA_ALWAYS_INLINE GA_HOST_DEVICE constexpr static decltype(auto) to_sequential_storage(std::tuple<ValueTypes...> &&tuple, std::index_sequence<Indices...> const) GA_NOEXCEPT {
                return make_sequential_storage(std::get<Indices>(std::move(tuple))...);
            }

            template<typename... ValueTypes>
            GA_ALWAYS_INLINE GA_HOST_DEVICE constexpr static decltype(auto) to_sequential_storage(std::tuple<ValueTypes...> &&tuple) GA_NOEXCEPT {
        ...
        struct make_vector {
            template<typename... Types>
            GA_ALWAYS_INLINE GA_HOST_DEVICE constexpr static CliffordExpression run(Types &&... coords) GA_NOEXCEPT {
        ...
        struct make_vector<CliffordExpression, std::enable_if_t<count_stored_values_v<typename CliffordExpression::expression_type> == 0> > {
            template<typename... Types>
            GA_ALWAYS_INLINE GA_HOST_DEVICE constexpr static CliffordExpression run(Types &&...) GA_NOEXCEPT {
    ...
    GA_HOST_DEVICE constexpr decltype(auto) vector(metric_space<MetricSpaceType> const &, Types &&... coords) GA_NOEXCEPT {
    ...
    namespace detail {
        ...
        GA_ALWAYS_INLINE GA_HOST_DEVICE constexpr decltype(auto) make_vector_using_iterator(metric_space<MetricSpaceType> const &mtr, IteratorType begin, std::index_sequence<Indices...>, ExtraTypes &&... extra_coords) GA_NOEXCEPT {
    ...
    GA_HOST_DEVICE constexpr decltype(auto) vector(metric_space<MetricSpaceType> const &mtr, IteratorType begin, IteratorType end) GA_NOEXCEPT {
        assert(MetricSpaceType::vector_space_dimensions == GA_STD_NAMESPACE::distance(begin, end));

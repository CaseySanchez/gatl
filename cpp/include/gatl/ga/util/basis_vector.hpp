...
namespace ga {
    ...
    GA_HOST_DEVICE constexpr unit_basis_vector_t e(index_t const index) GA_NOEXCEPT {
        assert(index > 0);
    ...
    GA_HOST_DEVICE constexpr unit_constant_basis_vector_t<Index> e(constant<IndexType, Index> const &) GA_NOEXCEPT {
